...
const AboutPage = () => {
  return (
    <Container>
      <div className='mx-3 ms-md-5 mt-5'>
        <div style={{marginTop: '80px'}}>
          <p style={{fontSize:"16px"}}>//About Brynex</p>
    ...
    <div style={{ marginTop: "80px" }} className="mx-3 ms-md-5 mb-5 pb-5">
      <Row style={{ color: "#171717" }} className="align-items-center">
        ...
        {/* Right Column */}
        <Col md={4}  style={{ color: "#171717" }}>
          <h3 style={{fontSize:"28px"}} className="mb-3">Our Vision</h3>
          <p className='mb-3' style={{ color: "#171717", opacity: "0.6" }}>     
