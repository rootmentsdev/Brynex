...
const HomePage = () => {
    return (
        <Container>
            <div className='mx-3 ms-md-5' style={{ marginTop: '80px', marginBottom: '40px' }}>
                <h1 style={{
                    fontSize: '48px',
                    fontWeight: '500',
                    marginBottom: '5px',
            ...
            <div className='mx-3 ms-md-5 mb-5' style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
                <Button style={{
                    width: 263,
                    height: 50,
                    borderRadius: 0,
            ...
            <div className='mx-3 ms-md-5 my-5 py-5'>
